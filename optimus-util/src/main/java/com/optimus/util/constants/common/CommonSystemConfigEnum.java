...
public enum CommonSystemConfigEnum {
    ...
    MERCHANT_CALLBACK_ONCE_EXECUTE_LIMIT("MERCHANT_CALLBACK_ONCE_EXECUTE_LIMIT", "回调商户一次执行上限"),
    ...
    CHANNEL_ORDER_QUERY_ONCE_EXECUTE_LIMIT("CHANNEL_ORDER_QUERY_ONCE_EXECUTE_LIMIT", "渠道订单查询一次执行上限"),
    ...
    RELEASE_ORDER_ONCE_EXECUTE_LIMIT("RELEASE_ORDER_ONCE_EXECUTE_LIMIT", "释放订单一次执行上限"),

    RELEASE_ORDER_INTERVAL("RELEASE_ORDER_INTERVAL", "释放订单间隔"),

    SPLIT_PROFIT_JOB_SHARDING("SPLIT_PROFIT_JOB_SHARDING", "订单分润定时任务分片"),

    SPLIT_PROFIT_ONCE_EXECUTE_LIMIT("SPLIT_PROFIT_ONCE_EXECUTE_LIMIT", "订单分润一次执行上限"),
